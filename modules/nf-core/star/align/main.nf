process STAR_ALIGN {
    ...
    def seq_platform_tag    = seq_platform ? "'PL:$seq_platform'" : ""
    def seq_center_tag      = seq_center ? "'CN:$seq_center'" : ""
    attrRG          = args.contains("--outSAMattrRGline") ? "" : "--outSAMattrRGline 'ID:$prefix' $seq_center_tag 'SM:$prefix' $seq_platform_tag"
